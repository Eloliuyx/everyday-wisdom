...
当前 **1.0.0 已正式发布并通过 Obsidian 社区自动审核**，采用英文内容 v0.4。源码与全部沉思已采用 MIT 公开。[社区页面](https://community.obsidian.md/plugins/everyday-wisdom)的 **Add to Obsidian** 链接已经可用。用户已反馈 macOS 中主要流程跑通；全新库商店安装、手机端及最低版本等详细验收仍未完成，具体材料见 [发布交接](PUBLISH.zh-CN.md)。
...
4. 产品负责人已完成 Obsidian Community 提交；自动审核已通过，没有 Error 或 Warning，公开安装入口已开放。
